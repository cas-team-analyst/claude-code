...
```
./agents/selector-chain-ladder-ldf-ai-framework.md
```
...
During a chain-ladder analysis, the `selector-chain-ladder-ldf-ai-framework` agent is tasked with making LDF selections. This agent (defined in `./agents/selector-chain-ladder-ldf-ai-framework.md`) embeds the full selection logic framework in its prompt. When it evaluates your triangle data, it works through:
...
|---|---|---|
| Adjust thresholds | Change CV outlier boundary from 0.10 to 0.15 | `selector-chain-ladder-ldf-ai-framework.md` |
| Change averaging windows | Default to 3-year instead of 5-year | `selector-chain-ladder-ldf-ai-framework.md` |
| Modify conservatism | Make downward movements faster (e.g., 50-70% instead of 30-50%) | `selector-chain-ladder-ldf-ai-framework.md` |
| Reorder decision hierarchy | Prioritize trending over Bayesian anchoring | `selector-chain-ladder-ldf-ai-framework.md` |
| Add a new criterion | Add a "Reinsurance Impact" criterion | `selector-chain-ladder-ldf-ai-framework.md` |
| Remove a criterion | Remove tail factor requirements | `selector-chain-ladder-ldf-ai-framework.md` |
| Adjust diagnostic sensitivity | Widen the no-action zone for closure rate from +/-3pp to +/-5pp | `selector-chain-ladder-ldf-ai-framework.md` |
...
Claude will read and present `./agents/selector-chain-ladder-ldf-ai-framework.md`.
...
> "In the selector-chain-ladder-ldf-ai-framework agent, move Sparse Data Caution above Bayesian Anchoring in the decision hierarchy. For our book of business, sparse data concerns should take priority over anchoring to priors."
...
| `./agents/selector-chain-ladder-ldf-ai-framework.md` | Agent definition that embeds the full selection logic framework (14 criteria + 10 diagnostics) and applies it to triangle data |

...
- [Draft Report](https://github.com/cas-team-analyst/team-analyst/blob/main/sample-data/sample-run/reserving-analysis/REPORT.md) — The draft analysis report generated by the workflow, demonstrating the documentation structure and narrative that TeamAnalyst produces.

- [Draft Analysis](https://github.com/cas-team-analyst/team-analyst/blob/main/sample-data/sample-run/reserving-analysis/Analysis.xlsx) — The draft analysis excel file generated by the workflow.

- [Replication Instructions](https://github.com/cas-team-analyst/team-analyst/blob/main/sample-data/sample-run/reserving-analysis/REPLICATE.md) — Complete reproducibility log documenting all input files, scripts run, customizations made, and manual selections applied. Enables a reviewer to reproduce the analysis results without AI assistance by following the documented steps exactly.

- [Peer Review Output](https://github.com/cas-team-analyst/team-analyst/blob/main/sample-data/sample-run/peer-review/PEER_REVIEW_REPORT.md) — The structured peer review evaluation of the completed analysis, showing how the tool identifies strengths, weaknesses, and areas requiring additional attention.

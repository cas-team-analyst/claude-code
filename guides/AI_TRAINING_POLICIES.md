...
1. **Consumer accounts train by default** — ChatGPT, Claude, Perplexity, DeepSeek, GitHub Copilot, and Cursor (including paid subscriptions) use your conversations or code for training unless you opt out.
...
|---|---|---|---|
| **Consumer** | ChatGPT Free/Plus/Pro, Claude Free/Pro/Max, Perplexity Free/Pro, DeepSeek, GitHub Copilot Individual, Cursor Free/Pro | Training ON | ✓ Manual opt-out available |
| **API / Enterprise** | OpenAI API, Claude for Work/Enterprise, Azure OpenAI, M365 Copilot, Perplexity Enterprise, DeepSeek API, GitHub Copilot Business/Enterprise, Cursor Business/Enterprise | No training | N/A — protected |
...
| **Antigravity CLI** | **Opt-out instructions:**<br>1. Open App Settings.<br>2. Disable **"Enable telemetry"**.<br><br>*Caution:* Telemetry settings control app logs, not Google's API servers. Even with telemetry disabled, avoid entering highly sensitive or proprietary actuarial data on unpaid developer accounts. | **Contractual no-training guarantee** applies **only to Paid (Billed) Services**. Unpaid/free tiers explicitly permit Google to use your inputs and outputs for model training. | &bull; [Gemini API Terms of Service](https://ai.google.dev/gemini-api/terms)<br>&bull; [Antigravity Privacy Discussion](https://discuss.ai.google.dev/t/antigravity-privacy/138277) |
...
If using consumer accounts professionally, configure your privacy settings immediately. Refer to the [Provider-by-provider policy summary](#provider-by-provider-policy-summary) table for step-by-step instructions and direct settings links for each tool.

Please note that these settings only protect future conversations or code, not past ones.
